 ...
 * 
 * @see test.models.NewTable
 * @author MyEclipse Persistence Tools
 */

public class NewTableDAO extends HibernateDaoSupport {
	...
	public NewTable findById(java.lang.Integer id) {
		...
		try {
			NewTable instance = (NewTable) getHibernateTemplate().get(
					"test.dao.NewTable", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public NewTable merge(NewTable detachedInstance) {
		...
		try {
			NewTable result = (NewTable) getHibernateTemplate().merge(
					detachedInstance);
	...
	public static NewTableDAO getFromApplicationContext(ApplicationContext ctx) {
		return (NewTableDAO) ctx.getBean("NewTableDAO");
	}
}